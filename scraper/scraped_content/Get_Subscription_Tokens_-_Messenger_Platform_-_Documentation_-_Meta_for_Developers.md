# Get Subscription Tokens - Messenger Platform - Documentation - Meta for Developers

Source: https://developers.facebook.com/docs/marketing-messages-on-messenger/get-subscription-tokens
...
Parameter | Type | Required | Description | Example || `limit` | Number | false | The maximum number of tokens to return in a single request.  **Default:** 100  **Maximum:** 1000 | `limit=100` |
...
Now that you have subscription tokens, start [sending marketing messages](/docs/marketing-messages-on-messenger/send-messages).
