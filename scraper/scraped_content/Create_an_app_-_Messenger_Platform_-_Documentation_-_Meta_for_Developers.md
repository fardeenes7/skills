# Create an app - Messenger Platform - Documentation - Meta for Developers

Source: https://developers.facebook.com/docs/messenger-platform/create-an-app
...
This document shows you how to customize the Engage with customers on Messenger use case you added to your app during the [app creation process](/docs/development/create-an-app/).
...
4. Click **Ready to test** to test each use case. If you need to submit your app for Meta App Review, you must test each use case. The [**Meta's Graph API Explorer**](/tools/explorer) allows you to test your queries and get access tokens and code samples for your queries.
...
3. If your app requires [App Review](/docs/resp-plat-initiatives/individual-processes/app-review/) click the **Actions** button and select **+ Add to App Review**. You'll complete the review submission later.
...
Feature or Permission | API usage | Allowed actions || [Business Asset User Profile](/docs/features-reference/business-asset-user-profile-access/) | Optional for this use case. | Can be added to this use case. |
| [`ads_management`](/docs/permissions#ads_management) | Optional for this use case. | Can be added to this use case. |
| [`business_management`](/docs/permissions#business_management) | **Required** for this use case. | **Cannot be removed** for this use case. |
| [`email`](/docs/permissions#email) | Optional for this use case. | Can be added to this use case. |
| [`instagram_basic`](/docs/permissions#instagram_basic) | Optional for this use case. | Can be added to this use case. |
| [`instagram_manage_messages`](/docs/permissions#instagram_manage_messages) | Optional for this use case. | Can be added to this use case. |
| [`page_manage_metadata`](/docs/permissions#page_manage_metadata) | **Required** for this use case. | **Cannot be removed** for this use case. |
| [`pages_messaging`](/docs/permissions#pages_messaging) | **Required** for this use case. | **Cannot be removed** for this use case. |
| [`pages_read_engagement`](/docs/permissions#pages_read_engagement) | Optional for this use case. | Can be added to this use case. |
| [`pages_show_list`](/docs/permissions#pages_show_list) | **Required** for this use case. | **Cannot be removed** for this use case. |
| [`pages_user_gender`](/docs/permissions#pages_user_gender) | Optional for this use case. | Can be added to this use case. |
| [`pages_user_locale`](/docs/permissions#pages_user_locale) | Optional for this use case. | Can be added to this use case. |
| [`pages_user_timezone`](/docs/permissions#pages_user_timezone) | Optional for this use case. | Can be added to this use case. |
| [`pages_utility_messaging`](/docs/permissions#pages_utility_messaging) | Optional for this use case. | Can be added to this use case. |
| [`paid_marketing_messages`](/docs/permissions#paid_marketing_messages) | Optional for this use case. | Can be added to this use case. |
| [`public_profile`](/docs/permissions#public_profile) | **Required** for this use case. | **Cannot be removed** for this use case.  Can increase access for any use case.\* |
...
* A [Privacy Policy](https://l.facebook.com/l.php?u=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FPrivacy_policy&h=AT7iqdFJQAnP_4qWmh3ahy4BjEDfeLfVLXtiJv8W5BBtVH1qmkD6zyA6bN1oZWHuabXQctqQCsJsU_HL5Qa3A1vpa2iGKyLh6sOlA0TjX0KKULS4ezGghNIV_6kYSy5cNUhXyc0Jo5206ADU) URL for your app
* A [data deletion](/docs/development/create-an-app/app-dashboard/data-deletion-callback/) URL with instructions or a callback that allows your app user to delete their data from your app.
...
* [Business verification](/docs/development/release/business-verification)
* [Permissions Reference](/docs/permissions)
* [Messenger Developer Documentation](/docs/messenger-platform)
