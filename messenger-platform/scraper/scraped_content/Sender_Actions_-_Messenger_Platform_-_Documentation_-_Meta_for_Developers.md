# Sender Actions - Messenger Platform - Documentation - Meta for Developers

Source: https://developers.facebook.com/docs/messenger-platform/send-messages/sender-actions
...
* Send `typing_on` and `typing_off` actions in the [separate batch requests](/docs/graph-api/making-multiple-requests). Batched requests are executed in order very quickly. This quick execution may result in the `typing_on` indicator being displayed for a fraction of a second if both actions are sent in the same batch.
...
* Use the [Meta Status tool](https://l.facebook.com/l.php?u=https%3A%2F%2Fmetastatus.com%2F&h=AT6u2-IZSzplwyIGP34V2hPIlQKWHs56-IW02U_CICHUWPyzfgD7P372Aob9pNefkzVR7rMjfppnoF8naaG3ydJi4UJ7PsJ2k2fuMiHgbkChSdjBlo4UrGgpBak9Zsy2kHSKpQuQZu-usFUZ) to check for the status and outages of Meta business products.
