# Postback Button Setup - Messenger Platform - Documentation - Meta for Developers

Source: https://developers.facebook.com/docs/marketing-messages-on-messenger/send-messages/postback
...
1. You will need to [setup a webhook](https://developers.facebook.com/docs/messenger-platform/webhooks/) to respond to the payload that we send when the button is clicked.
