...
Source: https://developers.facebook.com/docs/messenger-platform/get-started
...
* [Facebook Login](/docs/facebook-login/overview) in your app
* The
  [App Dashboard](/apps) in **Messenger > Settings**
...
To obtain your Page ID, send a `GET` request to the `/USER-ID/accounts` endpoint, replacing USER-ID with your actual your ID. You can also use `me` in place of the your User ID.
...
```
curl -i -X GET "https://graph.facebook.com/LATEST-API-VERSION/me/accounts
...
[**Open the Graph API Explorer**](/tools/explorer/)  in a new browser tab or window.
...
* [Attach Media Assets to your Message](/docs/messenger-platform/send-messages/saving-assets)
* [Send a customer a message after the 24-hour messaging window](/docs/messenger-platform/send-messages/message-tags)
* [Create a Message Template](/docs/messenger-platform/send-messages/templates)

## Learn More

* [Graph API](/docs/graph-api)
* [Graph API Explorer Tool](/docs/graph-api/guides/explorer)
* [Page Access Tokens](/docs/pages/access-tokens)
* [Page Permissions and Tasks](/docs/pages/overview/permissions-features)
* [Page/Messages Reference](/docs/graph-api/reference/page/messages)

### Developer Support

* Use the [Meta Status tool](https://l.facebook.com/l.php?u=https%3A%2F%2Fmetastatus.com%2F&h=AT5sBZJjLY2iy0hHKFmzwxEVgC3ByLOUczRIgWBEDDXQdj6-v4qJBjvp0HgBwYluFbceBjB3pn_U3idpNoIqPWusojDtDhvZ74uD_DxM-oI7wXrRuOWPw_lrwpcnRk4ypDL1j_ilFK3aiXKs) to check for the status and outages of Meta business products.
